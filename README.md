...
To view a live example, **[click here](https://sanjeev-js.github.io/)**
...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/sanjeev-js/Portfolio.git
  ```
...
Note here that if you click [my portfolio](https://sanjeev-js.github.io), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
